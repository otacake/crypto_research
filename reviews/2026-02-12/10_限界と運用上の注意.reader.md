...
## Length Check
- command: python C:/Users/shunsuke/.codex/skills/reader-length-check/scripts/check_chapter_length.py --budget ops/budget.md --file docs/manuscript/chapters/10_限界と運用上の注意.md --chapter \"第10章: 限界と運用上の注意\"
